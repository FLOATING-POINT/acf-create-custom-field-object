...
class PREFIX_acf_field_FIELD_NAME extends \acf_field {
	...
	public function __construct() {
		 ...
		 */
		$this->preview_image = $this->env['url'] . '/assets/images/PREFIX_acf_field_FIELD_NAME-preview.png';
	...
	public function input_admin_enqueue_scripts() {
		...
		$url     = get_template_directory_uri().'/acf-flp-fields/'; //TODO: This needs implementing properly
		$version = $this->env['version'];

		wp_register_script(
			'PREFIX-FIELD_NAMEe',
			"{$url}assets/js/PREFIX_acf_field_FIELD_NAME.js",
			array( 'acf-input' ),
			$version
		);
		...
		wp_register_style(
			'PREFIX-FIELD_NAME',
			"{$url}assets/css/PREFIX_acf_field_FIELD_NAME.css",
			array( 'acf-input' ),
			$version
		);

		wp_enqueue_script( 'PREFIX-FIELD_NAME' );
		wp_enqueue_style( 'PREFIX-FIELD_NAME' );
	}
}
